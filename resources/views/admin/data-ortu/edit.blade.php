        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box">
                    ...
                    <h4 class="page-title">Edit Identitas Orang Tua</h4>
                </div>
            </div>
        </div>
        <!-- end page title -->
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" id="tempat_lahir_tanggal_lahir_ayah"
                                            ...
                                            value="{{ old('tempat_lahir_tanggal_lahir_ayah', $dataOrtu->tempat_lahir_tanggal_lahir_ayah) }}">
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" id="pendidikan_ayah" name="pendidikan_ayah"
                                            ...
                                            value="{{ old('pendidikan_ayah', $dataOrtu->pendidikan_ayah) }}">
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea id="alamat_ayah" name="alamat_ayah" class="form-control" placeholder="Alamat Ayah">{{ old('alamat_ayah', $dataOrtu->alamat_ayah) }}</textarea>
                                    </div>
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" id="tempat_lahir_tanggal_lahir_ibu"
                                            ...
                                            value="{{ old('tempat_lahir_tanggal_lahir_ibu', $dataOrtu->tempat_lahir_tanggal_lahir_ibu) }}">
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" id="pendidikan_ibu" name="pendidikan_ibu"
                                            ...
                                            value="{{ old('pendidikan_ibu', $dataOrtu->pendidikan_ibu) }}">
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea id="alamat_ibu" name="alamat_ibu" class="form-control" placeholder="Alamat Ibu">{{ old('alamat_ibu', $dataOrtu->alamat_ibu) }}</textarea>
                                    </div>
